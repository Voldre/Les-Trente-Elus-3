...
import android.view.MotionEvent; // USE THE .MotionEvent !
...
public class WebPlayerActivity extends Activity {
    ...
    private static final String TAG_LOG = "WebPlayerActivity";
    ...
    private void createQuitDialog() {
        ...
        if (quitMessage.length() > 0) { // QUAND QUITTER le jeu : affiche bouton Annuler/Quitter
