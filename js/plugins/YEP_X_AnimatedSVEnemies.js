 ...
 *   project's img/enemies/ folder. Doing this will enable the following
...
DataManager.processSVENotetags1 = function(group) {
  ...
  for (var n = 1; n < group.length; n++) {
    ...
    obj.sideviewBreathSpeed = Math.max(20, Yanfly.Param.SVEBreathSpeed);
    obj.sideviewBreathXRate = Math.max(0.001, Yanfly.Param.SVEBreathXRate);
    obj.sideviewBreathYRate = Math.max(0.01, Yanfly.Param.SVEBreathYRate);
...
Sprite_Enemy.prototype.updateSVStateSprite = function() {
    ...
    this._stateSprite.y = (this._enemy.spriteHeight() + 128) * -1;
};
